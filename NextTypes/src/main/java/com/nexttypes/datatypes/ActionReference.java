...
public class ActionReference {
	...
	protected String referencingAction;
	protected String referencingField;
	
	public ActionReference(String referencingType, String referencingAction, String referencingField) {
	...
	public String getReferencingAction() {
		return referencingAction;
	}
